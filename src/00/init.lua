...
elseif e=="Xbox360"
then
AssetConfiguration.SetDefaultTargetDirectory"#Xbox"elseif e=="PS3"
then
AssetConfiguration.SetDefaultTargetDirectory"#PS3"elseif e=="XboxOne"
then
...
elseif e=="Android"
then
AssetConfiguration.SetDefaultTargetDirectory"#Android"elseif e=="iOS"
then
...
if o=="directx9"
then
GrTools.LoadShaderPack"shaders/win32/GrSystemShaders_win32.fsop"GrTools.LoadShaderPack"shaders/win32/GrModelShaders_win32.fsop"GrTools.LoadShaderPack"shaders/win32/FxShaders_win32.fsop"
end
if o=="directx11"
then
GrTools.LoadShaderPack"shaders/dx11/GrSystemShaders_dx11.fsop"GrTools.LoadShaderPack"shaders/dx11/GrModelShaders_dx11.fsop"GrTools.LoadShaderPack"shaders/dx11/FxShaders_dx11.fsop"
end
elseif e=="Xbox360"
then
GrTools.LoadShaderPack"shaders\\xbox360\\GrSystemShaders_x360.fsop"GrTools.LoadShaderPack"shaders\\xbox360\\GrModelShaders_x360.fsop"GrTools.LoadShaderPack"shaders\\xbox360\\FxShaders_x360.fsop"elseif e=="XboxOne"
then
GrTools.LoadShaderPack"shaders\\xboxone\\GrSystemShaders_xone.fsop"GrTools.LoadShaderPack"shaders\\xboxone\\GrModelShaders_xone.fsop"GrTools.LoadShaderPack"shaders\\xboxone\\FxShaders_xone.fsop"elseif e=="PS3"
then
GrTools.LoadShaderPack"shaders/ps3/GrSystemShaders_ps3.fsop.sdat"GrTools.LoadShaderPack"shaders/ps3/GrModelShaders_ps3.fsop.sdat"GrTools.LoadShaderPack"shaders/ps3/FxShaders_ps3.fsop.sdat"elseif e=="PS4"
then
GrTools.LoadShaderPack"shaders/ps4/GrSystemShaders_ps4.fsop"GrTools.LoadShaderPack"shaders/ps4/GrModelShaders_ps4.fsop"GrTools.LoadShaderPack"shaders/ps4/FxShaders_ps4.fsop"
end
GrTools.SetupSystemShaderResources()
end
if GrDaemon then
GrTools():EnableTextureStreaming()
if(e=="Windows"or e=="XboxOne")or e=="PS4"
then
...
if o=="directx9"
then
dofile"Fox/Scripts/Gr/gr_init.lua"GrTools.SetEnablePackedSmallTextureStreaming(true)
end
if o=="directx11"
then
...
if e=="XboxOne"or e=="PS4"
then
GrTools.SetEnableLnmForTerrainNormal(false)GrTools.SetEnableLnmForDecalNormal(false)
end
if e=="Xbox360"or e=="PS3"
then
GrTools.SetEnableLnmForTerrainNormal(true)GrTools.SetEnableLnmForDecalNormal(true)
end
end
...
dofile"shaders/win32/GrSystemShaders_win32.lua"dofile"shaders/win32/GrModelShaders_win32.lua"dofile"shaders/win32/FxShaders_win32.lua"
end
end
if o=="directx11"
then
...
dofile"shaders/dx11/GrSystemShaders_dx11.lua"dofile"shaders/dx11/GrModelShaders_dx11.lua"dofile"shaders/dx11/FxShaders_dx11.lua"
end
end
elseif e=="Xbox360"
then
dofile"shaders/xbox360/GrSystemShaders_x360.lua"dofile"shaders/xbox360/GrModelShaders_x360.lua"dofile"shaders/xbox360/FxShaders_x360.lua"elseif e=="XboxOne"
then
dofile"shaders/xboxone/GrSystemShadersNoLnm_xone.lua"dofile"shaders/xboxone/GrModelShadersNoLnm_xone.lua"dofile"shaders/xboxone/FxShadersNoLnm_xone.lua"elseif e=="PS3"
then
dofile"shaders/ps3/GrSystemShaders_ps3.lua"dofile"shaders/ps3/GrModelShaders_ps3.lua"dofile"shaders/ps3/FxShaders_ps3.lua"elseif e=="PS4"
then
dofile"shaders/ps4/GrSystemShadersNoLnm_ps4.lua"dofile"shaders/ps4/GrModelShadersNoLnm_ps4.lua"dofile"shaders/ps4/FxShadersNoLnm_ps4.lua"
end
end
...
}e:SetMainListener()CameraSelector.SetMainInstance(e)
end
if a then
a:Setup()
if Editor then
...
if FxDaemon then
FxDaemon.Initialize()FxDaemon.InitializeReserveObject"FxShaderPool"FxDaemon.InitializeReserveObject"FxMaterialManager"FxDaemon.InitializeReserveObject"FxTextureManager"FxDaemon.InitializeReserveObject"FxDecalSurfaceManager"FxDaemon.InitializeReserveObject"FxBlowOutEffectManager"
end
if Pad2 then
...
if Editor then
package.path=package.path..";/Assets/fox/editor_scripts/?.lua"package.path=package.path..";/Assets/mgo/editor_scripts/?.lua"
end
if Editor then
EdDemoEditBlockController.AddToolsBlockPath"/Assets/fox/demo/event/info/EdDemoEditTools.fpk"EdDemoEditBlockController.AddToolsBlockPath"/Assets/fox/demo/event/info/EdProceduralDemoEditTools.fpk"
end
