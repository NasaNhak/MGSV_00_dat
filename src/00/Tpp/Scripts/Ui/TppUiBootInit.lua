...
SubtitlesCommand:SetSubFilePath"/Assets/tpp/ui/Subtitles/sub_old/"SubtitlesCommand:SetSubpFilePath"/Assets/tpp/ui/Subtitles/subp/"SubtitlesCommand:SetDefaultGeneratorName"Default"SubtitlesCommand:SetSubFpkFilePath"/Assets/tpp/pack/ui/subtitles"
end
...
then
dofile"Tpp/Scripts/Ui/MgoUiBlocksConfig.lua"TppUiCommand.CreateResidentBlockController(152720,"/Assets/mgo/pack/ui/ui_resident_data.fpk")
elseif TppGameSequence.GetGameTitleName()=="TPP"
then
if TppGameSequence.GetTargetArea()=="ChinaKorea"
then
...
local m=AssetConfiguration.GetDefaultCategory"Language"local s=""local o=""local _=""local p=""local T=""local a=""local i=1
local t=3
local e="/Assets/tpp"
if TppSystemUtility.GetCurrentGameMode()=="MGO"
then
