local function t()coroutine.yield()
end
FoxFadeIo.FadeOut(0)
...
local e=SplashScreen.Create("cesa","/Assets/tpp/ui/ModelAsset/sys_logo/Pictures/common_cesa_logo_clp_nmp.ftex",1280,640)SplashScreen.Show(e,.5,4,.5)
end
if TppPlayLog and TppSystemUtility.GetCurrentGameMode()=="MGO"
then
...
ChVoiceTaskOrganizer.PrepareTaskPool("Player",1)ChVoiceTaskOrganizer.PrepareTaskPool("Enemy",8)ChVoiceTaskOrganizer.PrepareTaskPool("HqSquad",1)
end
if ChVoiceTaskOrganizer2 then
ChVoiceTaskOrganizer2.PrepareTaskPool("Player",1)ChVoiceTaskOrganizer2.PrepareTaskPool("Enemy",8)ChVoiceTaskOrganizer2.PrepareTaskPool("HqSquad",1)
end
if Editor then
if Preference then
local e=Preference.GetPreferenceEntity"EdRailPreference"
if not Entity.IsNull(e)and Fox.GetPlatformName()=="Windows"
then
if e.railSystemScript==""
then
...
if not Entity.IsNull(e)and e.characterType=="Soldier"
then
...
elseif e=="Xbox360"
then
GrTools.LoadShaderPack"shaders\\xbox360\\TppShaders_x360.fsop"dofile"shaders/xbox360/TppShaders_x360.lua"elseif e=="PS3"
then
GrTools.LoadShaderPack"shaders/ps3/TppShaders_ps3.fsop.sdat"dofile"shaders/ps3/TppShaders_ps3.lua"elseif e=="XboxOne"
then
GrTools.LoadShaderPack"shaders/xboxone/TppShaders_xone.fsop"dofile"shaders/xboxone/TppShadersNoLnm_xone.lua"elseif e=="PS4"
then
...
SubtitlesDaemon.SetDefaultVoiceLanguage"eng"SubtitlesCommand.SetVoiceLanguage"eng"
end
...
PhDaemon.SetUpdateDtMax(1/15)PhDaemon.SetWorldMin(Vector3(-4200,-1e3,-4200))PhDaemon.SetWorldMax(Vector3(4200,3e3,4200))
...
dofile"Tpp/Scripts/Ui/TppUiBootInit.lua"TppCassetteTapeInfo.Setup()
if Editor then
...
local e=e:GetScene"MainScene"local e=t:CreateBucket("SetupBucket",e)e:LoadProjectFile"/Assets/tpp/level/location/SetupLocation2.fxp"
end
if a=="Windows"
then
...
}NavWorldDaemon.AddWorld{sceneName="MainScene",worldName="sky",maxLoadFileCount=1,maxChunkCountPerFile=5}NavWorldDaemon.AddWorld{sceneName="MainScene",worldName="sahelan",maxLoadFileCount=2,maxChunkCountPerFile=6}
end
...
t()pcall(dofile,"/Assets/tpp/ui/Script/UiRegisterInfo.lua")t()
...
local e=e:GetMainGame()e:DEBUG_AddScript(t)Script.LoadLibrary"/Assets/tpp/editor_scripts/tpp_editor_menu2.lua"Script.LoadLibrary"/Assets/tpp/script/entry/MissionEntry.lua"Script.LoadLibrary"/Assets/tpptest/script/lib/MissionTest.lua"
end
end
