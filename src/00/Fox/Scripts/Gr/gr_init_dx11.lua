...
GrGraphicsSettingManager.SetPluginSettingSelection{allSettings={
{settingName="PluginShadow",settingTable={
...
{settingName="PluginSphericalHarmonics",settingTable={
...
{settingName="PluginLocalLight",settingTable={
...
{settingName="PluginModel",settingTable={
...
{settingName="PluginClone",settingTable={
{name="G7",RejectionLengthBias=0},
{name="G8E",RejectionLengthBias=0},
...
{settingName="TextureQualitySettings",settingTable={
...
{settingName="PluginDof",settingTable={
...
{settingName="PluginSsao",settingTable={
{name="G7",EnableFilter=1},
{name="G8E",EnableFilter=1},
{name="Default",EnableFilter=1},
{name="Off",EnableFilter=0},
...
{settingName="PluginSao",settingTable={
...
{settingName="PluginMotionBlur",settingTable={
...
{settingName="MotionBlurAmount",settingTable={
...
{settingName="PluginToneMap",settingTable={
...
{settingName="PluginLocalReflection",settingTable={
...
{settingName="PluginSubsurfaceScatter",settingTable={
{name="G7",EnableFilter=0,FadeOffset=0},
