...
s[10010]=function(p)
if TppPackList.IsMissionPackLabel"afterMissionClearMovie"
then
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.AFGH_SCRIPT)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/common/title_sequence.fpk"TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/story/s10010/s10010_l02.fpk"else
...
for p,s in pairs(s)do
TppHostage2.SetUniquePartsPath{gameObjectType="TppHostageUnique2",locatorName=p,parts=s}
end
local s={ish_p21_010410_0000="/Assets/tpp/parts/chara/ish/ish0_main0_def_v00.parts"}
for p,s in pairs(s)do
TppHostage2.SetUniquePartsPath{gameObjectType="TppHostage2",locatorName=p,parts=s}
end
end
local s={
{636,0,0,1}
...
local s={
{TppEnemyBodyId.oce0_main0_v00,1},
{TppEnemyBodyId.oce0_main0_v01,1}
}
TppEneFova.AddUniquePackage{type="hostage",body=s}do
local s="sol_enemyBase_0014"local s={
{type="enemy",name=s,faceId=635,bodyId=273}
}
...
local s="hos_s10033_0000"local s={
{type="hostage",name=s,faceId=602,bodyId=110}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.EAST_LV)
TppPackList.AddDefaultMissionAreaPack(p)do
local s="sol_vip_0000"local s={
{type="enemy",name=s,faceId=600,bodyId=TppEnemyBodyId.svs0_unq_v010}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.EAST_LV)
TppPackList.AddDefaultMissionAreaPack(p)do
local a="sol_s10040_0000"local p="sol_s10040_0001"local s="sol_s10040_0002"local s={
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.EAST_LV)
TppPackList.AddDefaultMissionAreaPack(p)do
local a="sol_vip_field"local p="sol_vip_village"local s="sol_vip_enemyBase"local s={
{type="enemy",name=a,faceId=637,bodyId=268},
{type="enemy",name=p,faceId=638,bodyId=269},
{type="enemy",name=s,faceId=639,bodyId=270}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
local p={
{258,1},
{TppEnemyBodyId.svs0_unq_v080,1}
}
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.EAST_WAV)
TppPackList.AddDefaultMissionAreaPack(p)do
local p="hos_target_0000"local s="sol_s10052_transportVehicle_0000"local s={
{type="hostage",name=p,faceId=607,bodyId=200},
{type="enemy",name=s,faceId=608,bodyId=263}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
TppPackList.AddDefaultMissionAreaPack(p)do
local p="hos_s10054_0002"local s="hos_s10054_0004"local s={
...
TppPackList.AddLocationCommonScriptPack(p)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)
if TppPackList.IsMissionPackLabel"beforeMotherBaseDemo"
then
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.OCELOT)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.MILLER)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HUEY)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/story/s10070/s10070_area04.fpk"elseif TppPackList.IsMissionPackLabel"beforeSahelanAttackDemo"
then
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HUEY)
...
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/story/s10070/s10070_area03.fpk"elseif TppPackList.IsMissionPackLabel"afterSahelanTestDemo"
then
...
TppPackList.AddLocationCommonScriptPack(p)
TppPackList.AddLocationCommonMissionAreaPack(p)
if TppPackList.IsMissionPackLabel"afterPumpStopDemo"
then
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.WALKERGEAR)
...
TppPackList.AddDefaultMissionAreaPack(p)do
local s="hos_mis_0000"local a="hos_mis_0001"local p="hos_mis_0002"local e="hos_mis_0003"local t="sol_interpreter"local i="sol_interrogator"local s={
{type="hostage",name=s,faceId=610,bodyId=111},
{type="hostage",name=a,faceId=611,bodyId=111},
{type="hostage",name=p,faceId=612,bodyId=111},
{type="hostage",name=e,faceId="female",bodyId=113},
{type="enemy",name=t,faceId=609,bodyId=255},
{type="enemy",name=i,faceId=629,bodyId=TppEnemyBodyId.pfs0_unq_v155}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
TppPackList.AddMissionPack(TppHelicopter.GetEnemyColoringPack(TppDefine.ENEMY_HELI_COLORING_TYPE.BLACK))
TppPackList.AddDefaultMissionAreaPack(p)do
local p="sol_pfCamp_vip_0001"local s="sol_pfCamp_vip_guard"local s={
{type="enemy",name=p,faceId=617,bodyId=TppEnemyBodyId.pfa0_v00_b},
{type="enemy",name=s,faceId=618,bodyId=254}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
local e="hos_diamond_0000"local t="hos_diamond_0001"local a="hos_diamond_0002"local i="hos_diamond_0003"local p="hos_diamond_0004"local s={
{type="enemy",name=o,faceId=616,bodyId=251},
{type="hostage",name=e,faceId=s,bodyId=130},
{type="hostage",name=t,faceId=s,bodyId=131},
{type="hostage",name=a,faceId=s,bodyId=132},
{type="hostage",name=i,faceId=s,bodyId=133},
{type="hostage",name=p,faceId=s,bodyId=134}
}
TppEneFova.AddUniqueSettingPackage(s)
end
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.WEST_LV)
if TppPackList.IsMissionPackLabel"AfterVolginDemo"
then
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.MANTIS)
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.WEST_LV)
TppPackList.AddDefaultMissionAreaPack(p)do
local s="sol_dealer"local p="sol_vip"local s={
...
local a="hos_s10115_0000"local t="hos_s10115_0001"local e="hos_s10115_0002"local i="hos_s10115_0003"local s="hos_s10115_0004"local p="hos_s10115_0005"local s={
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.WEST_LV)
TppPackList.AddDefaultMissionAreaPack(p)do
local s="hos_target_0000"local p="hos_target_0001"local s={
{type="hostage",name=s,faceId=642,bodyId=111}
}
local p={
{type="hostage",name=p,faceId=643,bodyId=113}
}
TppEneFova.AddUniqueSettingPackage(s)
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.WEST_LV)
TppPackList.AddDefaultMissionAreaPack(p)do
local s="sol_mis_0000"local s={
{type="enemy",name=s,faceId=620,bodyId=253}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)
TppPackList.AddDefaultMissionAreaPack(p)do
local s="hos_hillNorth_0000"local p="sol_hillNorth_0004"local s={
{type="hostage",name=s,faceId=619,bodyId=201}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.WEST_TRUCK_ITEMBOX)
TppPackList.AddDefaultMissionAreaPack(p)do
local s="hos_spy"local s={
{type="hostage",name=s,faceId="dd",bodyId=201}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
if TppPackList.IsMissionPackLabel"CamoParasiteAllKill"
then
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.WEST_WAV_CANNON)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.ENEMY_HELI)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/story/s10130/s10130_area02.fpk"elseif TppPackList.IsMissionPackLabel"CodeTalkerClearDemo"
then
...
TppPackList.AddLocationCommonScriptPack(p)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)
if TppPackList.IsMissionPackLabel"MBdemo"
then
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.MILLER)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HUEY)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.OCELOT)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.DD_SOLDIER_WAIT)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/story/s10140/s10140_area01.fpk"TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/free/f30050/f30050_Buddy.fpk"elseif TppPackList.IsMissionPackLabel"AfterClear"
then
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.CODETALKER)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/story/s10140/s10140_area00.fpk"else
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.CODETALKER)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/common/mis_com_mafr.fpk"TppPackList.AddDefaultMissionAreaPack(p)
end
end
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)
TppPackList.AddMissionPack(TppHelicopter.GetEnemyColoringPack(TppDefine.ENEMY_HELI_COLORING_TYPE.BLACK))
if TppPackList.IsMissionPackLabel"SkullFaceAppearance"
then
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.ENEMY_HELI)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.SKULLFACE)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.EAST_LV)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/story/s10150/s10150_area02.fpk"elseif TppPackList.IsMissionPackLabel"StartingSahelan"
then
...
TppPackList.AddLocationCommonScriptPack(p)
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)
if TppPackList.IsMissionPackLabel"OkbEnding"
then
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.EAST_LV)
TppPackList.AddDefaultMissionAreaPack(p)do
local s="hos_vip_0000"local p="sol_executioner_0000"local s={
{type="hostage",name=s,faceId=644,bodyId=271}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
TppPackList.AddDefaultMissionAreaPack(p)do
local s="sol_vip_0000"local s={
{type="enemy",name=s,faceId=649,bodyId=272}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
local s="sol_pfCamp_vip"local s={
{type="enemy",name=s,faceId=645,bodyId=267}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
...
s[10240]=function(p)
TppPackList.AddLocationCommonScriptPack(p)
if TppPackList.IsMissionPackLabel"InQuarantineFacility"
then
...
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.RAVEN)
if TppPackList.IsMissionPackLabel"MotherBaseDemo"
then
...
if TppPackList.IsMissionPackLabel"recoverVolginDemo"
then
...
if TppPackList.IsMissionPackLabel"AfterDemo"or TppPackList.IsMissionPackLabel"BattleHanger"
then
...
local a=TppDemo.IsUseMBDemoStage(TppDemo.GetMBDemoName())
if TppPackList.IsMissionPackLabel"DemoStage"
then
a=true
TppDemo.SetNextMBDemo(nil)
end
...
local s={
}table.insert(s,{type="hostage",name="TppHuey2GameObjectLocator",faceId=EnemyFova.INVALID_FOVA_VALUE,bodyId=p})
TppEneFova.AddUniqueSettingPackage(s)
end
...
do
TppEneFova.AddUniquePackage{type="hostage",body={
{371,1}
}
}
end
TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.DD_SOLDIER_WAIT)
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/free/f30050/f30050.fpk"TppPackList.AddFOBLayoutPack(p)
...
if TppPackList.IsMissionPackLabel"PS3Store"
then
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/common/title_sequence.fpk"TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/common/helispace_ps3store.fpk"elseif TppPackList.IsMissionPackLabel"avatarEdit"
then
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/common/title_sequence.fpk"TppPackList.AddAvatarEditPack()
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/heli/h40010/h40010_avatar.fpk"else
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/common/title_sequence.fpk"TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/heli/heli_ui.fpk"TppPackList.AddMissionPack(TppDefine.MISSION_COMMON_PACK.HELICOPTER)
TppPackList.AddLocationCommonScriptPack(p)
TppPackList.AddDefaultMissionAreaPack(p)
end
...
TppPackList.AddMissionPack"/Assets/tpp/pack/show/tgs_2014/s65060/s65060_area.fpk"TppPackList.AddLocationCommonScriptPack(p)do
local s="hos_s65060_0000"local s={
{type="hostage",name=s,faceId=621,bodyId=111}
}
TppEneFova.AddUniqueSettingPackage(s)
end
end
s[65415]={"/Assets/tpp/pack/show/tgs_2014/s65415/s65415_area.fpk"}s[65416]={"/Assets/tpp/pack/show/tgs_2014/s65416/s65416_area.fpk"}s[50050]=function(a)
local i=TppEnemy.GetDDSuit()
if TppMotherBaseManagement.GetMbsClusterSecurityIsEquipSwimSuit()then
local p=TppMotherBaseManagement.GetMbsClusterSecuritySwimSuitInfo()
local s
...
elseif i==TppEnemy.FOB_DD_SUIT_SNEAKING then
...
elseif i==TppEnemy.FOB_PF_SUIT_ARMOR then
...
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/online/o50050/o50050_additional.fpk"TppPackList.AddLocationCommonScriptPack(a)
if TppEnemy.IsSpecialEventFOB()then
TppPackList.AddMissionPack"/Assets/tpp/pack/mission2/online/o50050/o50055_area.fpk"else
TppPackList.AddDefaultMissionAreaPack(a)
end
TppPackList.AddFOBLayoutPack(a)
end
