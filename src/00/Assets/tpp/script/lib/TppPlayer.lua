...
if e.IsCurrentPlayerOcelot()then
...
r("Timer_StartGameOverCamera",.25)
end
...
r("Timer_StartPlayMissionClearCameraStep1",.25)
end
...
function e.PlayCommonMissionEndCamera(o,s,i,l,t,n)
local a
...
if a then
local e="Timer_StartPlayMissionClearCameraStep"..tostring(t+1)r(e,a)
end
end
...
{1,168},
{1,-164}
},skeletonNames=t,skeletonCenterOffsets=a,skeletonBoundings=n,offsetPos=e,focalLength=28,aperture=1.875,timeToSleep=i,interpTimeAtStart=r,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=o,useLastSelectedIndex=s}
return l
end
...
{3,160},
{3,-160}
},offsetTarget=a,offsetPos=e,focalLength=28,aperture=1.875,timeToSleep=o,interpTimeAtStart=t,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=r,useLastSelectedIndex=i}
return n
end
...
{7,165},
{7,-165}
},offsetTarget=a,offsetPos=t,focalLength=28,aperture=1.875,timeToSleep=r,interpTimeAtStart=n,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=o,useLastSelectedIndex=i}
return l
end
...
r("Timer_FOBStartPlayMissionClearCameraStep1",.25)
end
...
e=t(a)
if e then
local a="Timer_FOBStartPlayMissionClearCameraStep"..tostring(a+1)r(a,e)
end
end
...
Player.RequestToSetTargetStance(PlayerStance.STAND)r("Timer_FOBWaitStandStance",1)
else
...
{-10,170},
{-10,-170}
},skeletonNames=r,skeletonCenterOffsets=n,skeletonBoundings=a,offsetPos=t,focalLength=28,aperture=1.875,timeToSleep=20,interpTimeAtStart=e,fitOnCamera=false,timeToStartToFitCamera=1,fitCameraInterpTime=.3,diffFocalLengthToReFitCamera=16,callSeOfCameraInterp=i}
return o
end
...
r("Timer_StartPlayMissionAbortCamera",.25)
end
...
function e.OnPickUpCollection(r,t,a,i)
local r=255
...
local e={type="TppSupplyCboxSystem"}o(e,{id="RestoreRequest"})
end
end
function e.StoreSupplyCbox()
if e.IsExistSupplyCboxSystem()then
local e={type="TppSupplyCboxSystem"}o(e,{id="StoreRequest"})
end
end
...
local e={type="TppSupportAttackSystem"}o(e,{id="RestoreRequest"})
end
end
function e.StoreSupportAttack()
if e.IsExistSupportAttackSystem()then
local e={type="TppSupportAttackSystem"}o(e,{id="StoreRequest"})
end
end
...
local e={type="TppDecoySystem"}o(e,{id="StorePlayerDecoyInfos"})
end
end
...
r("Timer_DeliveryWarpSoundCannotCancel",a)
...
local n,t,r,e=e.EvaluateCaptureCage(t.x,t.z,t.grade,t.material)
if t~=0 then
...
function e.EvaluateCaptureCage(i,a,o,c)
local t=mvars
