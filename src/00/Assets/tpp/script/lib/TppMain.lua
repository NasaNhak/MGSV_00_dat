...
local i=TppQuest.IsCleard"mtbs_q99011"local n=not TppDemo.IsPlayedMBEventDemo"QuietWishGoMission"local e=TppDemo.GetMBDemoName()==nil
...
if TppGameSequence.GetGameTitleName()=="TPP"
then
...
if n.enemy then
if GameObject.DoesGameObjectExistWithTypeName"TppSoldier2"
then
...
function e.SetUpdateFunction(e)a={
}p=0
c={
}o=0
T={
...
}e[11050]=e[10050]e[11080]=e[10080]e[11140]=e[10140]e[10151]=e[10150]e[11151]=e[10150]
...
function e.SetMessageFunction(e)d={
}r=0
S={
}l=0
...
local T=h
local T=P
local T=TppDefine.MESSAGE_GENERATION[e]and TppDefine.MESSAGE_GENERATION[e]
[i]
if not T then
