...
local o=n(o)e(o,{id="SetEnabled",enabled=false})e(o,{id="SetSneakRoute",route=r,point=a})e(o,{id="SetCautionRoute",route=r,point=a})
if t then
...
local a=n(i)e(a,{id="SetPosition",position=s,rotY=0})
end
...
local o=n(o)e(o,{id="SetEnabled",enabled=false})e(o,{id="SetSneakRoute",route=t,point=a})e(o,{id="SetCautionRoute",route=t,point=a})
if l then
...
function o.DEBUG_AddSkipLogSVarsName(e)o.DEBUG_SkipOnChangeSVarsLog[e]=true
end
function o.DEBUG_FobGPU()
local e=function(o)math.randomseed(os.time())
...
for a,e in pairs(e)do
TppMotherBaseManagement.SetResourceSvars{resource=a,usableCount=e,processingCount=0,got=true,isNew=false}
end
end
do
...
TppMotherBaseManagement.SetClusterSvars{base="Fob1",category=e,grade=a,buildStatus="Completed",timeMinute=0,isNew=false}
end
for a,e in ipairs(e)do
...
local e={
{equipId=TppEquip.EQP_WP_30105,partsInfo={barrel=TppEquip.BA_30124,ammo=TppEquip.AM_30125,stock=TppEquip.SK_60304,muzzle=TppEquip.MZ_30105,muzzleOption=TppEquip.MO_30102,rearSight=TppEquip.ST_30305,frontSight=TppEquip.ST_30306,option1=TppEquip.LT_30105,option2=TppEquip.LS_40034,underBarrel=TppEquip.UB_50102,underBarrelAmmo=TppEquip.AM_40102}
},
{equipId=TppEquip.EQP_WP_60206,partsInfo={barrel=TppEquip.BA_60205,ammo=TppEquip.AM_30055,stock=TppEquip.SK_60203,muzzle=TppEquip.MZ_60203,muzzleOption=TppEquip.MO_60204,rearSight=TppEquip.ST_30204,frontSight=TppEquip.ST_20205,option1=TppEquip.LT_30025,option2=TppEquip.LS_30104,underBarrel=TppEquip.UB_40144,underBarrelAmmo=TppEquip.AM_40102}
},
{equipId=TppEquip.EQP_WP_20004,partsInfo={ammo=TppEquip.AM_20105,stock=TppEquip.SK_20002,muzzleOption=TppEquip.MO_10101,rearSight=TppEquip.ST_30114,option1=TppEquip.LT_10104}
}
}
GameObject.SendCommand({type="TppPlayer2",index=PlayerInfo.GetLocalPlayerIndex()},
{id="DEBUG_ChangeChimeraWeapon",chimeraInfo=e})
GameObject.SendCommand({type="TppPlayer2",index=PlayerInfo.GetLocalPlayerIndex()},
...
vars.itemLevels[TppEquip.EQP_SUIT-TppEquip.EQP_IT_InstantStealth]=1
local e={
{equipId=TppEquip.EQP_WP_30235,partsInfo={barrel=TppEquip.BA_30214,ammo=TppEquip.AM_30232,stock=TppEquip.SK_30205,muzzle=TppEquip.MZ_30232,muzzleOption=TppEquip.MO_30235,rearSight=TppEquip.ST_30202,frontSight=TppEquip.ST_30114,option1=TppEquip.LT_40103,option2=TppEquip.LS_30104,underBarrel=TppEquip.UB_50002,underBarrelAmmo=TppEquip.AM_50002}
},
{equipId=TppEquip.EQP_WP_60317,partsInfo={barrel=TppEquip.BA_30044,ammo=TppEquip.AM_30102,stock=TppEquip.SK_60205,muzzle=TppEquip.MZ_30213,muzzleOption=TppEquip.MO_30105,rearSight=TppEquip.ST_50303,option1=TppEquip.LT_30025,option2=TppEquip.LS_30104,underBarrel=TppEquip.UB_40043,underBarrelAmmo=TppEquip.AM_40001}
},
{equipId=TppEquip.EQP_WP_20215,partsInfo={ammo=TppEquip.AM_20106,stock=TppEquip.SK_20216,muzzleOption=TppEquip.MO_20205,rearSight=TppEquip.ST_60102,option1=TppEquip.LS_10415}
}
}
GameObject.SendCommand({type="TppPlayer2",index=PlayerInfo.GetLocalPlayerIndex()},
{id="DEBUG_ChangeChimeraWeapon",chimeraInfo=e})
...
e(a,{1,.5,.5},"Now gvars.usingNormalMissionSlot is false, but not emergency mission. Call scripter!!!!!!")
end
...
e(a,{1,.5,.5},"Now vars.fobSneakMode isFobMode.MODE_SHAM, but not fob mission. Call scripter!!!!!!")
end
if TppSave.DEBUG_EraseAllGameDataCounter then
if TppSave.DEBUG_EraseAllGameDataCounter>0 then
e(a,{1,.5,.5},"TppSave.EraseAllGameDataSaveRequest : erase game data save request!")
...
local o=o.DEBUG_GetSysVarsLog()e(a,{.5,.5,1},"LuaSystem showSysVars")
for r,o in ipairs(o)do
e(a,o)
end
local o={
[FobMode.MODE_ACTUAL]="MODE_ACTUAL",[FobMode.MODE_SHAM]="MODE_SHAM",[FobMode.MODE_VISIT]="MODE_VISIT",[FobMode.MODE_NONE]="MODE_NONE"}e(a,"vars.fobSneakMode = "..tostring(o[vars.fobSneakMode]))
local o=TppScriptVars.GetVarValueInSlot(TppDefine.SAVE_SLOT.MB_MANAGEMENT,"vars","mbmTppGmp",0)e(a,"GMP(inSlot) = "..tostring(o))
local o=TppScriptVars.GetVarValueInSlot(TppDefine.SAVE_SLOT.MB_MANAGEMENT,"vars","mbmTppHeroicPoint",0)e(a,"HeroicPoint(inSlot) = "..tostring(o))e(a,"killCount = "..tostring(n.killCount))e(a,"totalKillCount = "..tostring(gvars.totalKillCount))
end
...
local o={"PRIMARY_HIP","PRIMARY_BACK","SECONDARY"}e(a,{.5,.5,1},"LuaSystem WeaponVars")
for o,r in ipairs(o)do
local o=TppDefine.WEAPONSLOT[r]e(a,string.format("Slot:%16s : vars.initWeapons = %04d, vars.weapons = %04d",r,vars.initWeapons[o],vars.weapons[o]))
end
for o=0,7 do
e(a,string.format("Slot:%d : vars.supportWeapons = %04d, vars.initSupportWeapons = %04d, gvars.ply_lastWeaponsUsingTemp = %04d",o,vars.supportWeapons[o],vars.initSupportWeapons[o],gvars.ply_lastWeaponsUsingTemp[o+TppDefine.WEAPONSLOT.SUPPORT_0]))
end
for o=0,7 do
e(a,string.format("Slot:%d : vars.items = %04d, vars.initItems = %04d, gvars.ply_lastItemsUsingTemp = %04d",o,vars.items[o],vars.initItems[o],gvars.ply_lastItemsUsingTemp[o]))
end
end
...
e(a,string.format("   Task %1d : [%s] %s %06.2f : ( Current %06.2f )",o,t,r,n[o].threshold,FobUI.GetCurrentEventTaskValue(o,s)))
end
end
e(a,{.5,1,.5},"FobSneak eventTask")
for a=0,7 do
...
e(a,{.5,1,.5},"FobDefence eventTask")
for a=0,7 do
...
e(a,{.5,.5,1},"LuaUI ShowOnlineChallengeTask")
...
if s then
local r=r.qaDebug.debugOnlineChallengeTaskTextTable and r.qaDebug.debugOnlineChallengeTaskTextTable[s]
if not r then
r="threshold is"
end
e(a,string.format("   Task %02d : [%s] %s %06.2f : ( Current %06.2f )",o,t,r,n[o].threshold,OnlineChallengeTask.GetCurrentTaskValue(o)))
end
end
...
e(a,{.5,.5,1},"LuaUI ShowOnlineChallengeTaskVersion")e(a,string.format("   ServerVersion : %d",TppNetworkUtil.GetOnlineChallengeTaskVersion()))e(a,string.format("    LocalVersion : %d",gvars.localOnlineChallengeTaskVersion))
end
end
...
local a=e.color or"white"local e=e.text or""a=o._GetColor(a)GrxDebug.Print2D{life=r,x=n,y=s,size=t,color=a,args={e}
}
end
...
function o.AddReturnToSelector(e)e:AddItem("< return",DebugSelector.Pop)
end
...
r(a,{.5,.5,1},"Now neew wait mission initialize.")
end
if n.returnSelect then
TppUI.FadeOut(0)
TppSave.ReserveVarRestoreForMissionStart()
TppMission.SafeStopSettingOnMissionReload()tpp_editor_menu2.StartTestStage(6e4)n.returnSelect=false
end
if n.showSVars then
r(a,"")r(a,{.5,.5,1},"LuaMission DBG.showSVars")
...
r(a,"hotZone : "..o)r(a,"hotZone clear check : isNotAlert = "..(tostring(e.debug.notHotZone_isNotAlert)..(", isPlayerStatusNormal = "..(tostring(e.debug.notHotZone_isPlayerStatusNormal)..(", isNotHelicopter = "..tostring(e.debug.notHotZone_isNotHelicopter))))))r(a,"Mission clear timer: "..tostring(v"Timer_OutsideOfHotZoneCount"))r(a,{.5,1,.5},"Recent all target status")
...
r(a,{.5,.5,1},"LuaMission MIS.showClearState")r(a,"missionClearState = "..tostring(TppDefine.MISSION_CLEAR_STATE_LIST[gvars.mis_missionClearState+1]))
end
...
r(a,"")r(a,{.5,.5,1},"LuaSystem DBG.showSysSVars")
...
r(a,string.format(" %s = %s",tostring(e),tostring(o)))
for o=0,(o-1)do
r(a,string.format("   %s[%d] = %s",tostring(e),o,tostring(t[e]
[o])))
end
end
end
...
r(a,{.5,.5,1},"LuaSystem DBG.showPerf")
for n,e in pairs(p)do
r(a," perf["..(o.PERF_CHECK_TYPE[n]..("] = "..e)))
end
end
if e.debug.AnimalBlock then
r(a,{.5,.5,1},"LuaSystem DBG.AnimalBlock")
local t,n=Tpp.GetCurrentStageSmallBlockIndex()r(a,string.format("current block position (x,y) = (%03d, %03d)",t,n))r(a,"Load animal block area = "..tostring(e.animalBlockAreaName))
local t=ScriptBlock.GetScriptBlockId"animal_block"local n
...
r(a,"OnMessage "..(tostring(n)..(" OnReload "..tostring(t))))o.ShowMessageTable(a,"MessageTable",e.animalBlockScript.messageExecTable)
else
...
r(a,{.5,.5,1},"LuaMessage subScripts")
...
r(a,{.5,.5,1},"LuaMessage location")
end
if(n.showLibraryMessageTable>0)then
r(a,{.5,.5,1},"LuaMessage library")
...
GameObject.SendCommand({type="TppPlayer2",index=PlayerInfo.GetLocalPlayerIndex()},
{id="DEBUG_ChangeEquip",equipId={l}
})
...
function o.ErrorNotSupportYet(e)
end
