...
{main="s10040"},
{flag={"s10041","s10044","s10052","s10054"},sub={"s10050"},defaultClose={s10050=true},proceedCount=3,condition=function()
local e
...
return e
end,updateTiming={OnMissionStart=true,OnCompletedPlatform=true}
},
...
{main="s10090",condition=function()
...
{flag={"s10211"},condition=function()
...
{main="s10140"},
{main="s10150"},
{main="s10151",condition=function()
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,2)
TppQuest.StartElapsedEvent(1)
return true
end},
{flag={"s10045"},sub={"s11043","s11054"},condition=function()
if TppQuest.IsCleard"tent_q99040"
then
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,2)
TppQuest.StartElapsedEvent(1)
return true
end
end,updateTiming={OnSideOpsClear=true,OnMissionStart=true}
},
{flag={"s10093"},sub={"s11082","s11090"},condition=function()
return TppQuest.OpenChildSoldier_1()
end,updateTiming={OnSideOpsClear=true,OnMissionStart=true}
},
{flag={"s10156"},sub={"s11033","s11050"},defaultClose={s11050=true},condition=function()
return(TppQuest.IsCleard"tent_q20910"and TppQuest.IsCleard"fort_q20911")and TppQuest.IsCleard"sovietBase_q20912"
end,updateTiming={OnMissionStart=true,OnSideOpsClear=true}
},
{main="s10171",condition=function()
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,1)
TppQuest.StartElapsedEvent(3)
return true
end},
{sub={"s11140"},condition=function()
...
end,updateTiming={OnMissionStart=true,OnUpdateCheckPoint=true,OnSideOpsClear=true}
},
{main="s10240",defaultClose={s10240=true},condition=function()
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,1)
TppQuest.StartElapsedEvent(3)
return true
end},
{sub={"s11080"},condition=function()
...
{sub={"s11130","s11044","s11151","s10260","s10280"},defaultClose={s10260=true,s10280=true},condition=function()
...
end,updateTiming={BeforeBuddyBlockLoad=true}
},
{
},
{
...
return e and n
end,demoName="HappyBirthDay"},HappyBirthDay={storyCondition=function()
return true
end,detailCondition=function()
TppDemo.UpdateHappyBirthDayFlag()
return TppDemo.mtbsPriorityFuncList.HappyBirthDay()
end,demoName="HappyBirthDay"},HappyBirthDayRadio={storyCondition=function(e)
return e.demoName=="HappyBirthDay"
end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0511"}
},QuietTreatment={storyCondition=function(e)
return e.demoName=="ArrivedMotherBaseAfterQuietBattle"
end,detailCondition=function(e)
local e=not TppRadio.IsPlayed"f2000_rtrg1345"local n=TppBuddyService.DidObtainBuddyType(BuddyType.QUIET)
local i=TppQuest.IsOpen"sovietBase_q99020"local t=not TppQuest.IsCleard"sovietBase_q99020"return((e and n)and i)and t
end,radioList={"f2000_rtrg1345","f2000_rtrg1347"}
},QuietTreatment2={storyCondition=function(e)
return e.demoName=="ArrivedMotherBaseAfterQuietBattle"
end,detailCondition=function(e)
local t=not TppRadio.IsPlayed"f2000_rtrg1345"local n=TppBuddyService.DidObtainBuddyType(BuddyType.QUIET)
local e=not TppQuest.IsOpen"sovietBase_q99020"local i=TppQuest.IsCleard"sovietBase_q99020"return(t and n)and(e or i)
end,radioList={"f2000_rtrg1345","f2000_rtrg1346"}
...
return e and n
end,demoName="QuietReceivesPersecution"},QuietReceivesPersecutionRadio={storyCondition=function(e)
return e.demoName=="QuietReceivesPersecution"
end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0360"}
...
end,demoName="QuietHasFriendshipWithChild"},QuietHasFriendshipWithChildRadio={storyCondition=function(e)
...
end,radioList={"f6000_rtrg0350","f2000_rtrg7350"}
...
end,demoName="InterrogateQuiet"},InterrogateQuietRadio={storyCondition=function()
return e.CanPlayDemoOrRadio"InterrogateQuiet"
end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg0330","f2000_rtrg7330"}
},QuietPassage={storyCondition=function()
return e.IsMissionCleard(10086)
end,detailCondition=function()
if TppQuest.IsOpen"mtbs_q99011"
then
...
if TppQuest.IsOpen"mtbs_q99050"
then
...
return true
end,radioList={"f2000_rtrg8270"}
},EliLookSnake={storyCondition=function()
return e.CanPlayDemoOrRadio"RafeAccidentalDeath"
end,detailCondition=function()
return true
end,demoName="EliLookSnake"},EliLookSnakeRadio={storyCondition=function()
return e.CanPlayDemoOrRadio"RafeAccidentalDeath"
end,detailCondition=function()
return true
end,selectRadioFunction=function(e)
...
end,radioList={"f6000_rtrg0325","f2000_rtrg7325"}
},CompliteDevelopBattleGear={storyCondition=function()
return e.CanPlayDemoOrRadio"OpenSideOpsAiPod"
end,detailCondition=function()
return true
end,demoName="DevelopedBattleGear5"},CompliteDevelopBattleGearRadio={storyCondition=function()
return e.CanPlayDemoOrRadio"CompliteDevelopBattleGear"
end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
return true
end,radioList={"f2000_rtrg8451","f2000_rtrg8290"}
},ProgressQuestChildSoldier={storyCondition=function()
local n=TppQuest.IsCleard"outland_q20913"and TppQuest.IsCleard"lab_q20914"local e=not((TppQuest.IsOpen"tent_q20910"and TppQuest.IsOpen"fort_q20911")and TppQuest.IsOpen"sovietBase_q20912")
return n and e
end,detailCondition=function()
TppQuest.OpenAndActivateSpecialQuest{"tent_q20910","fort_q20911","sovietBase_q20912"}
return true
end,radioList={"f2000_rtrg8310"}
...
return true
end,radioList={"f2000_rtrg8452"}
},EliImprisonment={storyCondition=function()
return e.CanPlayDemoOrRadio"TheGreatEscapeLiquid"
end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg0332","f2000_rtrg7332"}
...
return false
end,radioList={"f2000_rtrg8360"}
},PermitParasiticWormCarrierKill={storyCondition=function()
return e.CanPlayDemoOrRadio"ParasiticWormCarrierKill"
end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,demoName="ParasiticWormCarrierKill"},AfterParasiticWormCarrierKillFree={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8400"}
},OpenDecisionHuey={storyCondition=function()
return e.CanPlayDemoOrRadio"DecisionHuey"
end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg0338","f2000_rtrg7338"}
...
end,demoName="DecisionHuey"},OpenQuietLost={storyCondition=function()
return true
end,detailCondition=function()
...
end,radioList={"f2000_rtrg2000","f2000_rtrg2010"}
...
e.eventPlayTimmingTable={blackTelephone={
...
e.PLAY_DEMO_END_MISSION={
[10010]=true,[10030]=true,[10050]=true,[10070]=true,[10100]=true,[10110]=true,[10120]=true,[10130]=true,[10140]=true,[10150]=true,[10151]=true,[10240]=true,[10260]=true,[10280]=true,[10230]=true,[11050]=true,[11070]=true,[11100]=true,[11110]=true,[11130]=true,[11140]=true,[11150]=true,[11151]=true,[11240]=true,[11260]=true,[11280]=true,[11230]=true}
...
local n=true
local r={
[10240]=true,[10115]=true,[10030]=true}
if r[t]then
n=false
end
...
local i=TppDefine.MISSING_NUMBER_MISSION_ENUM[t]
if not i then
local t=tonumber(t)n=n+TppUI.GetTaskCompletedNumber(t)e=e+TppUI.GetMaxMissionTask(t)
end
end
return n,e
end
...
if TppGameSequence.GetSpecialVersionName()=="e3_2015"
then
return false
end
...
if i=="BeforeBuddyBlockLoad"or i=="OnMissionClear"
then
...
t=e.ProceedStorySequence()n=e.GetCurrentStorySequence()
if n<TppDefine.STORY_SEQUENCE.STORY_FINISH then
i=false
else
i=true
...
if TppDemo.IsPlayedMBEventDemo"TheGreatEscapeLiquid"
then
return false
end
local n=TppQuest.IsCleard"outland_q20913"or TppQuest.IsCleard"lab_q20914"local e=(TppQuest.IsCleard"tent_q20910"and TppQuest.IsCleard"fort_q20911")and TppQuest.IsCleard"sovietBase_q20912"
if n and(not e)then
return false
end
return true
...
local n=e.GetCurrentStorySequence()
if gvars.forceMbRadioPlayedFlag[TppDefine.FORCE_MB_RETURN_RADIO_ENUM.CompliteDevelopBattleGearRadio]or TppDemo.IsPlayedMBEventDemo"DevelopedBattleGear5"
then
return 5
...
return 1
elseif TppDemo.IsPlayedMBEventDemo"AnableDevBattleGear"
then
return 0
end
return-1
...
return t.demoName,a
elseif r then
if n=="blackTelephone"or n=="clearSideOpsForceMBRadio"
then
gvars.forceMbRadioPlayedFlag[TppDefine.FORCE_MB_RETURN_RADIO_ENUM[o]
]=true
end
if n=="freeHeliRadio"
then
...
if n=="blackTelephone"or n=="clearSideOpsForceMBRadio"
then
if gvars.forceMbRadioPlayedFlag[TppDefine.FORCE_MB_RETURN_RADIO_ENUM[i]
]then
for n,e in ipairs(e.radioList)do
...
local t=e.GetForceMBDemoNameOrRadioList"forceMBDemo"e.GetForceMBDemoNameOrRadioList("blackTelephone",{demoName=t})
...
function e.DEBUG_SetStorySequence(t,o)do
return
end
