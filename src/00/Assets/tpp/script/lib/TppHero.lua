...
local o=o or"heroicPointDown"local n=n or"heroicPointUp"
...
local n=e.MISSION_CLEAR[TppDefine.MISSION_CLEAR_RANK_LIST[n]
].heroicPoint
...
{msg="ChangePhase",func=function(o,n)
...
{msg="Dead",func=function(i,r,_,o)
...
local n=n({type="TppBossQuiet2"},
{id="GetQuietType"})
if n==Fox.StrCode32"Cam"
then
e.SetAndAnnounceHeroicOgrePoint(e.DYING_PARASITE,"destroyed_skull","destroyed_skull")
end
end
end},
{msg="BreakGimmick",func=e.AnnounceBreakGimmick},
...
{msg="DogBiteConnect",func=e.HorseRided},
{msg="ZombBiteConnect",func=e.HorseRided},
...
{msg="OnBreakPlaced",func=e.OnBreakPlaced}
}
}
end
function e.Init(n)
...
{name="her_missionHeroPoint",type=TppScriptVars.TYPE_INT32,value=0,save=true,sync=false,wait=false,category=TppScriptVars.CATEGORY_MISSION},nil}
end
