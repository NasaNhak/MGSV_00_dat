...
local r=4
e.GMP_POSTER=500
e.FOB_TUTORIAL_STATE={INIT=0,INTRODUCTION_CONSTRUCT_FOB=1,CONSTRUCT_FOB=2,INTRODUCTION_FOB_MISSIONS=3,FOB_MISSIONS=4,FINISH=127}
e.unitLvAnnounceLogTable={
...
e.EMBLEM_LOCATOR_TABLE={
["ly003_cl00_collct0000|cl00pl0_uq_0000_collct|col_develop_MTBS_0000"]="front8",["ly003_cl00_collct0000|cl00pl0_uq_0000_collct|col_develop_MTBS_0001"]="front10",["ly003_cl00_collct0000|cl00pl0_uq_0000_collct|col_develop_MTBS_0002"]="front15",["ly003_cl00_collct0000|cl00pl0_uq_0000_collct|col_develop_MTBS_0003"]="front16",["ly003_cl04_collct0000|cl04pl0_uq_0040_collct|col_emblem_quiet"]="front9",col_develop_MTBS_30150_0000="front11",col_develop_MTBS_30250_0000="front7"}
local n={
}
if TppDefine.GMP_COST_TYPE then
n[TppDefine.GMP_COST_TYPE.FULTON]="gmpCostFulton"n[TppDefine.GMP_COST_TYPE.SUPPORT_SUPPLY]="gmpCostSupply"n[TppDefine.GMP_COST_TYPE.SUPPORT_ATTACK]="gmpCostAttack"n[TppDefine.GMP_COST_TYPE.CALL_HELLI]="gmpCostHeli"n[TppDefine.GMP_COST_TYPE.BUDDY]="gmpCostOps"n[TppDefine.GMP_COST_TYPE.CLEAR_SIDE_OPS]="gmpGet"n[TppDefine.GMP_COST_TYPE.DESTROY_SUPPORT_HELI]="add_alt_machine"
end
...
function e.ClearStaffNewIcon(n,a,t,e)
...
if a then
local e=e.keyItemAnnounceLogTable[t]
if e then
TppUI.ShowAnnounceLog("find_keyitem",e)
end
elseif n then
local e=e.keyItemRewardTable[t]
if e then
...
function e.AddVolunteerStaffs()
local e=TppStory.GetCurrentStorySequence()
if e<TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE then
return
end
local e={
[10010]=true,[10030]=true,[10240]=true,[10280]=true,[30050]=true,[30150]=true,[30250]=true,[50050]=true}
...
function e.UnSetUsageRestriction(t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_REWORD,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_DEVELOP,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_STAFF,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_COMBAT,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_BASE,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_BASE_EXPANTION,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_BASE_SECURITY,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_RESOURCE,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_DB,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_DB_PFRATING,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_DB_CASSETTE,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_CUSTOM,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_EMERGENCIE_F,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_EMERGENCIE_N,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_SIDEOPSLIST,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_LOCATION,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_RETURNMB,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_DROP,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_BUDDY,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_ATTACK,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_HELI,t)
end
function e.UnSetUsageRestrictionOnFOB(t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_REWORD,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_DEVELOP,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_STAFF,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MBM_COMBAT,t)
...
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_EMERGENCIE_N,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_SIDEOPSLIST,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_CHALLENGE,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_LOCATION,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_RETURNMB,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_DROP,t)
TppUiCommand.SetMbTopMenuItemActive(e.MBDVCMENU.MSN_BUDDY,t)
...
function e.SetDevelpedByDevelopIdList(e)
for t,e in ipairs(e)do
TppMotherBaseManagement.SetEquipDeveloped{equipDevelopID=e}
end
end
function e.IsNeedPlayPandemicTutorialRadio()
...
return e.PandemicTutorialStoryCondition()
end
function e.PandemicTutorialStoryCondition()
if TppStory.GetCurrentStorySequence()>=TppDefine.STORY_SEQUENCE.CLEARD_FLAG_MISSIONS_AFTER_WHITE_MAMBA then
return true
end
return false
end
function e.StartPandemicEvent()
if gvars.trm_donePandemicEvent then
return
end
...
function e.IsNeedStartPandemicTutorial()
if not TppMotherBaseManagement.IsPandemicEventMode()then
return false
end
if gvars.trm_donePandemicEvent then
...
function e.UpdatePandemicEventBingoCount()
...
function e.GetPandemicBingoCount()
...
local n={GROUP_A={storySequence=TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE,missionList={10033,10043,10036},proceedCount=1,privilegeNameList={"RESCUE_HOSTAGE_E20010_001","RESCUE_HOSTAGE_E20010_002","RESCUE_HOSTAGE_E20010_003","RESCUE_HOSTAGE_E20010_004","RESCUE_FRIENDMAN"},dlcItem={STAFF_STAFF1_FOX={"STAFF_STAFF1_FOX_01","STAFF_STAFF1_FOX_02"}
}
},GROUP_B={storySequence=TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON,privilegeNameList={"RESCUE_SP_HOSTAGE","RESCUE_HOSTAGE_E20020_000","RESCUE_HOSTAGE_E20020_001","RESCUE_ENEMY_US_MISSION_TARGET_CENTER000","RESCUE_ENEMY_US_MISSION_TARGET_SQUAD000"},dlcItem={STAFF_STAFF2_MSF={"STAFF_STAFF2_MSF_01","STAFF_STAFF2_MSF_02"}
}
},GROUP_C={storySequence=TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON,missionList={10041,10044,10052,10054},proceedCount=2,privilegeNameList={"RESCUE_HOSTAGE_E20030_000","RESCUE_HOSTAGE_E20030_001","RESCUE_HOSTAGE_E20030_002","RESCUE_E20030_BETRAYER","RESCUE_E20030_MASTERMIND"},dlcItem={STAFF_STAFF3_DD={"STAFF_STAFF3_DD_01","STAFF_STAFF3_DD_02"}
}
},GROUP_D={storySequence=TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY,privilegeNameList={"RESCUE_HOSTAGE_E20050_000","RESCUE_HOSTAGE_E20050_001","RESCUE_HOSTAGE_E20050_002","RESCUE_HOSTAGE_E20050_003","RESCUE_GENOME_SOILDER_SAVE"},dlcItem={STAFF_STAFF4_FOX_HOUND={"STAFF_STAFF4_FOX_HOUND_01","STAFF_STAFF4_FOX_HOUND_02"}
}
}
}
function e.AcquirePrivilegeStaff()
...
local t=DlcItem[t]
if t then
e.AcquireDlcItem(t,e._AcquireDlcItemStaff,n)
end
end
end
end
...
function e._AcquireDlcItemStaff(n,t)
for n,t in ipairs(t)do
local e=e._AcquirePrivilegeStaff(t,"fromExtra")
if not e then
return
end
end
...
function e._AcquirePrivilegeStaff(t,n)
local t=TppDefine.UNIQUE_STAFF_TYPE_ID[t]
if not t then
return
end
return e._AddUniqueVolunteerStaff(t,n)
end
...
local n={WEAPON_MACHT_P5_WEISS=t.EXTRA_4000,WEAPON_RASP_SB_SG_GOLD=t.EXTRA_4001,WEAPON_PB_SHIELD_SIL=t.EXTRA_4002,WEAPON_PB_SHIELD_OD=t.EXTRA_4003,WEAPON_PB_SHIELD_WHT=t.EXTRA_4004,WEAPON_PB_SHIELD_GLD=t.EXTRA_4005,ITEM_CBOX_APD=t.EXTRA_4006,ITEM_CBOX_RT=t.EXTRA_4007,ITEM_CBOX_WET=t.EXTRA_4008,SUIT_FATIGUES_APD=t.EXTRA_4015,SUIT_FATIGUES_GRAY_URBAN=t.EXTRA_4016,SUIT_FATIGUES_BLUE_URBAN=t.EXTRA_4017,SUIT_FATIGUES_BLACK_OCELOT=t.EXTRA_4018,WEAPON_ADAM_SKA_SP=t.EXTRA_4024,WEAPON_WU_S333_CB_SP=t.EXTRA_4025,SUIT_MGS3_NORMAL=t.EXTRA_4019,SUIT_MGS3_SNEAK=t.EXTRA_4022,SUIT_MGS3_TUXEDO=t.EXTRA_4023,SUIT_THE_BOSS=t.EXTRA_4026,SUIT_EVA=t.EXTRA_4027,HORSE_WESTERN=t.EXTRA_4028,HORSE_PARADE=t.EXTRA_4009,ARM_GOLD=t.EXTRA_6000}
local function o(t,e)
local e=n[e]
TppMotherBaseManagement.DirectAddDataBase{dataBaseId=e,isNew=true}
return true
end
local function r(a,e)
local a=Fox.GetPlatformName()
local e=n[e]
if a=="Xbox360"or a=="XboxOne"
then
...
local n=DlcItem[t]
if n then
e.EraseDlcItem(n,r,t)
e.AcquireDlcItem(n,o,t)
end
end
end
function e.AcquireDlcItemEmblem()
...
local t=DlcItem[t]
if t then
e.EraseDlcItem(t,a,n)
e.AcquireDlcItem(t,r,n)
end
end
end
function e.AcquireGzPrivilege(e,t)
...
function e.AcquireDlcItem(e,t,n)
...
local n={
[t.STAFF_UNIQUE_TYPE_ID_OCELOT]=TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE,[t.STAFF_UNIQUE_TYPE_ID_MILLER]=TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE,[t.STAFF_UNIQUE_TYPE_ID_HEUY]=TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY,[t.STAFF_UNIQUE_TYPE_ID_CODE_TALKER]=TppDefine.STORY_SEQUENCE.CLEARD_METALLIC_ARCHAEA}
...
function e.GetFobStatus()
if gvars.ini_isTitleMode then
return
end
TppServerManager.GetFobStatus()
end
function e.OnNoticeFobSneaked(t,n)
if e.IsDisableNoticeFobSneaked()then
return
end
local n={
[FobMode.MODE_ACTUAL]="fobNoticeIntruder",[FobMode.MODE_SHAM]="fobReqPractice",[FobMode.MODE_VISIT]="fobVisitFob"}
local t=n[t]
if t then
TppMotherBaseManagement.SetMyFobEmergency{emergency=true}
e.ShowNoticeFobSneaked(t)
end
end
function e.OnNoticeSupporterFobSneaked()
if e.IsDisableNoticeFobSneaked()then
return
end
TppMotherBaseManagement.SetFollowerFobEmergency{emergency=true}
e.ShowNoticeFobSneaked"fobReqHelp"
end
function e.IsDisableNoticeFobSneaked()
local e=false
local n={
[10010]=true,[10030]=true,[10115]=true,[10150]=true,[10151]=true,[10240]=true,[10260]=true,[10280]=true,[11151]=true}
...
function e.ShowNoticeFobSneaked(e)
...
for t,e in pairs(e.EMBLEM_LOCATOR_TABLE)do
...
{name="trm_isBuddyRecovered",type=TppScriptVars.TYPE_BOOL,arraySize=r,value=false,save=true,sync=false,wait=false,category=TppScriptVars.CATEGORY_MB_MANAGEMENT},nil}
end
function e.Messages()
local a=TppEnemy.GetCpIntelTrapTable()
local n
if a and next(a)then
n={
}
for a,t in pairs(a)do
local r={msg="Enter",sender=t,func=function(t,t)
e.OnEnterCpIntelTrap(a)
if TppSequence.IsMissionPrepareFinished()then
e.ShowLocationAndBaseTelop()
end
end,option={isExecMissionPrepare=true}
}table.insert(n,r)
local e={msg="Exit",sender=t,func=function(t,t)
e.OnExitCpIntelTrap(a)
end,option={isExecMissionPrepare=true}
}table.insert(n,e)
end
table.insert(n,{msg="Enter",sender="trap_intel_afgh_waterway_cp",func=function(t,t)
e.SetBaseTelopName"afgh_waterWay_cp"
if TppSequence.IsMissionPrepareFinished()then
e.ShowLocationAndBaseTelop()
end
end,option={isExecMissionPrepare=true}
...
e.SetBaseTelopName"afgh_ruins_cp"
if TppSequence.IsMissionPrepareFinished()then
e.ShowLocationAndBaseTelop()
end
end,option={isExecMissionPrepare=true}
...
return Tpp.StrCode32Table{GameObject={
{msg="Fulton",func=function(r,n,t,a)
if not TppMission.IsFOBMission(vars.missionCode)then
e.OnFultonMessage(r,n,t,a)
end
end,option={isExecMissionClear=true,isExecDemoPlaying=true}
},
{msg="FultonInfo",func=function(n,t,a)
if not TppMission.IsFOBMission(vars.missionCode)then
e.OnFultonInfoMessage(n,t,a)
end
end,option={isExecMissionClear=true,isExecDemoPlaying=true}
},
{msg="FultonFailedEnd",func=e.OnFultonFailedEnd},
{msg="HeliDoorClosed",func=e.OnRecoverByHelicopter,option={isExecDemoPlaying=true}
},
{msg="Returned",func=e.OnRecoverByHelicopter,option={isExecDemoPlaying=true}
}
...
{msg="WeatherForecast",func=e.TerminalVoiceWeatherForecast},
{msg="Clock",sender="TerminalVoiceOnSunSet",func=e.TerminalVoiceOnSunSet},
{msg="Clock",sender="TerminalVoiceOnSunRise",func=e.TerminalVoiceOnSunRise},
{msg="Clock",sender="WolfHowl",func=function()
if TppLocation.GetLocationName()=="afgh"
then
if not TppMission.IsHelicopterSpace(vars.missionCode)then
...
{msg="NoticeSneakMotherBase",func=e.OnNoticeFobSneaked},
{msg="NoticeSneakSupportedMotherBase",func=e.OnNoticeSupporterFobSneaked}
}
}
end
function e.OnMessage(a,o,_,M,n,r,t)
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,a,o,_,M,n,r,t)
end
function e.OnFultonMessage(e,n,t,a)
...
if t then
e.OnFulton(t[1],t[2],t[3],t[4],nil,nil,a,r)
...
if t then
e._OnFultonFailedEnd(t[1],t[2],t[3],t[4],a)
...
if t then
e.SetUpStoryBeforeCleardRescueMillerOnHelicopter()
else
e.SetUpStoryBeforeCleardRescueMiller()
end
elseif gvars.str_storySequence<=TppDefine.STORY_SEQUENCE.CLEARD_RECUE_MILLER then
e.SetUpStoryCleardRescueMiller()
elseif gvars.str_storySequence<=TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE then
e.SetUpStoryCleardToMotherBase()
elseif gvars.str_storySequence<=TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON then
e.SetUpStoryCleardHoneyBee()
elseif gvars.str_storySequence<=TppDefine.STORY_SEQUENCE.CLEARD_DESTROY_THE_FLOW_STATION then
e.SetUpStoryCleardPitchDark()
else
e.SetUpStoryAfterCleardPitchDark()
end
if e.IsReleaseSection"Combat"
then
e.EnableDvcMenuByList{
{menu=e.MBDVCMENU.MBM_COMBAT,active=true}
}
end
if e.IsReleaseSection"Security"
then
...
e.EnableDvcMenuByList{
{menu=e.MBDVCMENU.MSN_DROP,active=false},
{menu=e.MBDVCMENU.MSN_BUDDY,active=false},
{menu=e.MBDVCMENU.MSN_ATTACK,active=false},
{menu=e.MBDVCMENU.MSN_HELI_ATTACK,active=false}
}
...
function e.SetUpArmsMBDVCMenu()
if e.IsOpenMBDvcArmsMenu()then
e.EnableDvcMenuByList{
{menu=e.MBDVCMENU.MBM_DEVELOP_ARMS,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_ARMS,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_ARMS_HELI,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_ARMS_VEHICLE,active=true}
}
end
end
function e.SetUpCustomWeaponMBDVCMenu()
if gvars.str_storySequence<TppDefine.STORY_SEQUENCE.CLEARD_DESTROY_THE_FLOW_STATION then
return
end
do
e.EnableDvcMenuByList{
{menu=e.MBDVCMENU.MBM_CUSTOM_WEAPON,active=true}
}
end
end
function e.SetUpBuddyMBDVCMenu()
if gvars.str_storySequence<=TppDefine.STORY_SEQUENCE.CLEARD_RECUE_MILLER then
return
end
e.EnableDvcMenuByList{
{menu=e.MBDVCMENU.MSN_BUDDY,active=true}
}
e.EnableDvcMenuByList{
{menu=e.MBDVCMENU.MSN_BUDDY_EQUIP,active=true}
}
...
local n=TppBuddyService.CanSortieBuddyType(t)
if n then
local t=e.BUDDY_MB_DVC_MENU[t]
if t then
e.EnableDvcMenuByList(t)
end
end
end
end
...
function e.OnFulton(t,n,r,a,M,_,o,i)
if _ then
mvars.trm_needHeliSoundOnAddStaffsFromTempBuffer=true
end
...
e.DoFuncByFultonTypeSwitch(t,n,r,a,M,o,i,e.OnFultonSoldier,e.OnFultonVolgin,e.OnFultonHostage,e.OnFultonVehicle,e.OnFultonContainer,e.OnFultonGimmickCommon,e.OnFultonBuddy,e.OnFultonEnemyWalkerGear,e.OnFultonAnimal,e.OnFultonBossQuiet,e.OnFultonParasiteSquad)
end
function e.IncrementFultonCount()svars.trm_missionFultonCount=svars.trm_missionFultonCount+1
end
function e.GetMissionHumanFultonCount()
...
function e.GetFultonCountKeyItem()
local n=gvars.trm_recoveredSoldierCount+gvars.trm_recoveredHostageCount
if n>=E then
e.AcquireKeyItem{dataBaseId=t.DESIGN_3006,isShowAnnounceLog=true}
end
if n>=s then
e.AcquireKeyItem{dataBaseId=t.DESIGN_3005,isShowAnnounceLog=true}
end
end
function e.IsEqualOrMoreTotalFultonCount(e)
...
PlayRecord.RegistPlayRecord"SOLDIER_RESCUE"Tpp.IncrementPlayData"totalRescueCount"TppUI.UpdateOnlineChallengeTask{detectType=2,diff=1}
end
...
function e.OnFultonHostage(t,n,n,r,a,o)
local M=TppMotherBaseManagement.GetTempStaffStatusFromGameObject{gameObjectId=t}
local n
if r then
n=r
...
e.IncrementFultonCount()
if not a then
e.IncrementRecoveredHostageCount()
end
...
TppMotherBaseManagement.AddTempGimmickResource{gimmickName=e,reduceAmount=t}
end
end
e.GIMMICK_RESOURCE_ID_TABLE={
[1845465265]=t.RESOURCE_ID_EMPLACEMENT_GUN_EAST,[2207998916]=t.RESOURCE_ID_EMPLACEMENT_GUN_WEST,[1187982616]=t.RESOURCE_ID_MORTAR_NORMAL,[3601635493]=t.RESOURCE_ID_ANTI_AIR_GATLING_GUN_EAST,[20562949]=t.RESOURCE_ID_ANTI_AIR_GATLING_GUN_WEST}
function e.OnFultonGimmickCommon(n,n,n,a,n,t)
if mvars.trm_isSkipAddResourceToTempBuffer then
return
end
local n=e.GIMMICK_RESOURCE_ID_TABLE[a]
if n then
e.AddTempResource(n,nil,t)
else
e.AddTempResource(a,nil,t)
end
end
...
function e.OnFultonEnemyWalkerGear(n,n,n,t,n,n)
if mvars.trm_isSkipAddResourceToTempBuffer then
return
end
e.AddTempResource(t)
...
if e.IsAnimalDog(n)then
e.AddAnimalRecoverHistory(t.ANIMAL_TYPE_DOG)
elseif e.IsAnimalHorse(n)then
e.AddAnimalRecoverHistory(t.ANIMAL_TYPE_HORSE)
elseif e.IsAnimalBear(n)then
e.AddAnimalRecoverHistory(t.ANIMAL_TYPE_BEAR)
elseif e.IsAnimalGoat(n)then
e.AddAnimalRecoverHistory(t.ANIMAL_TYPE_GOAT)
else
local t=0
e.AddAnimalRecoverHistory(t)
end
...
PlayRecord.RegistPlayRecord"ANIMAL_RESCUE"e.AddTempDataBaseAnimal(n,tostring(mvars.animalBlockAreaName))
end
...
function e.GetAnimalTypeCountFromRecoveredHistory(t)
local e=0
...
function e.AddAnimalRecoverHistory(t)
...
function e.OnFultonBossQuiet(t,t,t,t)
local t=i({type="TppBossQuiet2"},
{id="GetQuietType"})
local t=e.parasiteSquadFultonResouceId[t]
if t then
e._OnFultonParasiteSquad(t)
end
end
function e.OnFultonParasiteSquad(t,n,n,n)
local t=i(t,{id="GetParasiteType"})
local t=e.parasiteSquadFultonResouceId[t]
if t then
e._OnFultonParasiteSquad(t)
end
end
function e._OnFultonParasiteSquad(t)
local t,n=t[1],t[2]
e.AddTempResource(t,n)
...
function e.OnRecoverByHelicopter()
TppHelicopter.SetNewestPassengerTable()
e.OnRecoverByHelicopterAlreadyGetPassengerList()
TppHelicopter.ClearPassengerTable()
end
function e.OnRecoverByHelicopterOnCheckPoint()
TppHelicopter.SetNewestPassengerTable()
...
function e.OnRecoverByHelicopterAlreadyGetPassengerList()
local t=TppHelicopter.GetPassengerlist()
if t==nil then
TppHelicopter.ClearPassengerTable()
return
...
e.OnFulton(t,nil,nil,nil,true,false,PlayerInfo.GetLocalPlayerIndex())
end
end
end
function e.CheckAddTempBuffer(e)
if TppMission.IsFOBMission(vars.missionCode)then
...
function e.AddTempStaffFulton(t)
...
function e.AddTempResource(a,n,t)
local t=t or 0
...
function e.AddTempDataBaseAnimal(t,e)
TppMotherBaseManagement.AddTempDataBaseAnimal{dataBaseId=t,areaName=e}
end
local n=4
local n=1.67
function e.AddPickedUpResourceToTempBuffer(t,a)
if not e.RESOURCE_INFORMATION_TABLE[t]then
return
end
...
function e.SetUpOnHelicopterSpace()
e.SetUp()
end
function e.SetUpStoryBeforeCleardRescueMiller()
e._SetUpDvcMenu{
{menu=e.MBDVCMENU.MSN,active=true},
{menu=e.MBDVCMENU.MSN_EMERGENCIE_N,active=true},
{menu=e.MBDVCMENU.MSN_EMERGENCIE_F,active=true},
{menu=e.MBDVCMENU.MSN_LOG,active=true},
{menu=e.MBDVCMENU.MBM_REWORD,active=true},
{menu=e.MBDVCMENU.MBM_DB_CASSETTE,active=true}
}
end
function e.SetUpStoryBeforeCleardRescueMillerOnHelicopter()
e._SetUpDvcMenu{
{menu=e.MBDVCMENU.MSN,active=true},
{menu=e.MBDVCMENU.MSN_EMERGENCIE_N,active=true},
{menu=e.MBDVCMENU.MSN_EMERGENCIE_F,active=true},
...
function e.SetUpStoryCleardRescueMiller()
e._SetUpDvcMenu{
{menu=e.MBDVCMENU.MBM,active=true},
{menu=e.MBDVCMENU.MSN,active=true},
{menu=e.MBDVCMENU.MBM_REWORD,active=true},
{menu=e.MBDVCMENU.MBM_STAFF,active=true},
{menu=e.MBDVCMENU.MBM_DEVELOP,active=true},
{menu=e.MBDVCMENU.MBM_DEVELOP_WEAPON,active=true},
{menu=e.MBDVCMENU.MBM_BASE,active=true},
{menu=e.MBDVCMENU.MBM_LOG,active=true},
{menu=e.MBDVCMENU.MSN_DROP,active=true},
{menu=e.MBDVCMENU.MSN_DROP_BULLET,active=true},
{menu=e.MBDVCMENU.MSN_DROP_LOADOUT,active=true},
{menu=e.MBDVCMENU.MSN_DROP_VEHICLE,active=true},
{menu=e.MBDVCMENU.MSN_HELI,active=true},
{menu=e.MBDVCMENU.MSN_HELI_RENDEZVOUS,active=true},
{menu=e.MBDVCMENU.MSN_HELI_ATTACK,active=true},
{menu=e.MBDVCMENU.MSN_HELI_DISMISS,active=true},
{menu=e.MBDVCMENU.MSN_EMERGENCIE_N,active=true},
{menu=e.MBDVCMENU.MSN_EMERGENCIE_F,active=true},
{menu=e.MBDVCMENU.MSN_LOG,active=true},
{menu=e.MBDVCMENU.MSN_LOCATION,active=true},
{menu=e.MBDVCMENU.MSN_RETURNMB,active=true},
{menu=e.MBDVCMENU.MBM_DB,active=true},
{menu=e.MBDVCMENU.MBM_DB_ENCYCLOPEDIA,active=true},
{menu=e.MBDVCMENU.MBM_DB_KEYITEM,active=true},
{menu=e.MBDVCMENU.MBM_DB_CASSETTE,active=true}
}
end
function e.SetUpStoryCleardToMotherBase()
local t={
{menu=e.MBDVCMENU.MBM,active=true},
{menu=e.MBDVCMENU.MSN,active=true},
{menu=e.MBDVCMENU.MBM_REWORD,active=true},
...
{menu=e.MBDVCMENU.MBM_DEVELOP_WEAPON,active=true},
{menu=e.MBDVCMENU.MBM_BASE,active=true},
{menu=e.MBDVCMENU.MBM_BASE_EXPANTION,active=true},
{menu=e.MBDVCMENU.MBM_RESOURCE,active=true},
{menu=e.MBDVCMENU.MBM_LOG,active=true},
{menu=e.MBDVCMENU.MSN_DROP,active=true},
{menu=e.MBDVCMENU.MSN_DROP_BULLET,active=true},
{menu=e.MBDVCMENU.MSN_DROP_WEAPON,active=true},
{menu=e.MBDVCMENU.MSN_DROP_LOADOUT,active=true},
{menu=e.MBDVCMENU.MSN_DROP_VEHICLE,active=true},
{menu=e.MBDVCMENU.MSN_HELI,active=true},
{menu=e.MBDVCMENU.MSN_HELI_RENDEZVOUS,active=true},
...
{menu=e.MBDVCMENU.MSN_EMERGENCIE_N,active=true},
{menu=e.MBDVCMENU.MSN_EMERGENCIE_F,active=true},
{menu=e.MBDVCMENU.MSN_MISSIONLIST,active=true},
{menu=e.MBDVCMENU.MSN_SIDEOPSLIST,active=TppQuest.CanOpenSideOpsList()},
{menu=e.MBDVCMENU.MSN_LOG,active=true},
{menu=e.MBDVCMENU.MSN_LOCATION,active=true},
{menu=e.MBDVCMENU.MSN_RETURNMB,active=true},
{menu=e.MBDVCMENU.MBM_DB,active=true},
...
{menu=e.MBDVCMENU.MBM_DB_CASSETTE,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_DESIGN,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_DESIGN_EMBLEM,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_DESIGN_BASE,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_AVATAR,active=true}
}
e._SetUpDvcMenu(t)
end
function e.IsOpenMBDvcArmsMenu()
...
{menu=e.MBDVCMENU.MSN_DROP_LOADOUT,active=true},
{menu=e.MBDVCMENU.MSN_DROP_VEHICLE,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_ARTILLERY,active=true},
{menu=e.MBDVCMENU.MSN_HELI,active=true},
{menu=e.MBDVCMENU.MSN_HELI_RENDEZVOUS,active=true},
{menu=e.MBDVCMENU.MSN_HELI_ATTACK,active=true},
{menu=e.MBDVCMENU.MSN_HELI_DISMISS,active=true},
...
{menu=e.MBDVCMENU.MSN_EMERGENCIE_F,active=true},
{menu=e.MBDVCMENU.MSN_MISSIONLIST,active=true},
{menu=e.MBDVCMENU.MSN_SIDEOPSLIST,active=true},
{menu=e.MBDVCMENU.MSN_LOG,active=true},
{menu=e.MBDVCMENU.MSN_LOCATION,active=true},
{menu=e.MBDVCMENU.MSN_RETURNMB,active=true},
{menu=e.MBDVCMENU.MBM_DB,active=true},
...
{menu=e.MBDVCMENU.MBM_COMBAT,active=true},
{menu=e.MBDVCMENU.MBM_BASE,active=true},
{menu=e.MBDVCMENU.MBM_BASE_SECURITY,active=true},
{menu=e.MBDVCMENU.MBM_BASE_EXPANTION,active=true},
{menu=e.MBDVCMENU.MBM_RESOURCE,active=true},
{menu=e.MBDVCMENU.MBM_LOG,active=true},
{menu=e.MBDVCMENU.MSN_DROP,active=true},
...
{menu=e.MBDVCMENU.MSN_ATTACK,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_ARTILLERY,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_SMOKE,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_SLEEP,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_CHAFF,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_WEATHER,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_WEATHER_SANDSTORM,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_WEATHER_STORM,active=true},
{menu=e.MBDVCMENU.MSN_ATTACK_WEATHER_CLEAR,active=true},
{menu=e.MBDVCMENU.MSN_HELI,active=true},
{menu=e.MBDVCMENU.MSN_HELI_RENDEZVOUS,active=true},
{menu=e.MBDVCMENU.MSN_HELI_ATTACK,active=true},
{menu=e.MBDVCMENU.MSN_HELI_DISMISS,active=true},
...
{menu=e.MBDVCMENU.MSN_MISSIONLIST,active=true},
{menu=e.MBDVCMENU.MSN_SIDEOPSLIST,active=true},
{menu=e.MBDVCMENU.MSN_FOB,active=true},
{menu=e.MBDVCMENU.MSN_FRIEND,active=true},
{menu=e.MBDVCMENU.MSN_LOG,active=true},
{menu=e.MBDVCMENU.MSN_LOCATION,active=true},
{menu=e.MBDVCMENU.MSN_RETURNMB,active=true},
{menu=e.MBDVCMENU.MBM_DB,active=true},
...
{menu=e.MBDVCMENU.MBM_DB_CASSETTE,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_BUDDY,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_BUDDY_HORSE,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_BUDDY_DOG,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_BUDDY_QUIET,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_BUDDY_WALKER,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_BUDDY_BATTLE,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_DESIGN,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_DESIGN_EMBLEM,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_DESIGN_BASE,active=true},
{menu=e.MBDVCMENU.MBM_CUSTOM_AVATAR,active=true}
...
local n={
[TppDefine.WEATHER.SUNNY]="VOICE_WEATHER_CLAER",[TppDefine.WEATHER.CLOUDY]=nil,[TppDefine.WEATHER.RAINY]=nil,[TppDefine.WEATHER.SANDSTORM]="VOICE_WEATHER_SANDSTORM",[TppDefine.WEATHER.FOGGY]=nil}
local a={
[TppDefine.WEATHER.SUNNY]="weather_sunny",[TppDefine.WEATHER.CLOUDY]="weather_cloudy",[TppDefine.WEATHER.RAINY]="weather_rainy",[TppDefine.WEATHER.SANDSTORM]="weather_sandstorm",[TppDefine.WEATHER.FOGGY]="weather_foggy"}
local n=n[t]
local t=a[t]
if n then
e.PlayTerminalVoice(n)
end
if t then
TppUI.ShowAnnounceLog(t)
end
end
function e.TerminalVoiceOnSunSet()
if mvars.trm_stopChangeDayTerminalAnnounce then
return
end
e.PlayTerminalVoice"VOICE_SUN_SET"TppUI.ShowAnnounceLog"sunset"TppTutorial.DispGuide_Comufrage()
end
function e.TerminalVoiceOnSunRise()
if mvars.trm_stopChangeDayTerminalAnnounce then
return
end
e.PlayTerminalVoice"VOICE_SUN_RISE"TppUI.ShowAnnounceLog"sunrise"TppTutorial.DispGuide_DayAndNight()
end
function e.TerminalVoiceOnSupportFireIncoming()
e.PlayTerminalVoice"VOICE_SUPPORT_FIRE_INCOMING"
end
...
function e.ShowLocationAndBaseTelopForStartFreePlay()
...
function e.ShowLocationAndBaseTelopForContinue()
if TppMission.IsFreeMission(vars.missionCode)then
e.ShowLocationAndBaseTelopForStartFreePlay()
else
...
function e.OnEnterCpIntelTrap(e)
...
function e.IsReleaseMedicalSection()
...
e.SectionOpenCondition={Combat=function()
...
end,Medical=e.IsReleaseMedicalSection,Security=function()
...
if e.IsReleaseMedicalSection()then
...
if gvars.trm_isPushRewardSeparationPlatform and(not e.CheckPandemicEventFinish())then
return true
else
return false
end
end}
function e.IsReleaseSection(t)
local e=e.SectionOpenCondition[t]
if e then
return e()
end
end
function e.ReleaseMbSection()
for n,t in ipairs(e.MOTHER_BASE_SECTION_LIST)do
local e=e.IsReleaseSection(t)
if e~=nil then
...
for t,e in ipairs(e.MOTHER_BASE_SECTION_LIST)do
...
if(gvars.str_storySequence>=TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON)and(TppStory.GetClearedMissionCount{10041,10044,10052,10054}>=1)then
local t=1
e.ForceStartBuildPlatform("Medical",t)
e.ForceStartBuildPlatform("Develop",t)
end
e.PushRewardOnMbSectionOpen()
if e.IsBuiltAnimalPlatform()and(not gvars.trm_isPushRewardAnimalPlatform)then
...
if TppQuest.IsCleard"mtbs_q99011"
then
...
local a={BuddyCommand.HORSE_SHIT,BuddyCommand.DOG_BARKING,BuddyCommand.QUIET_AIM_TARGET,BuddyCommand.QUIET_COMBAT_START,BuddyCommand.QUIET_SHOOT_THIS}
...
function e.AddUniqueVolunteerStaff(n)
local a={
{186},
{209},
{210,211},
...
local t={
[10033]=1,[10036]=1,[10043]=1,[10080]=2,[10086]=3,[10082]=4,[10091]=5,[10195]=6,[10100]=7,[10110]=8,[10121]=9,[10070]=10,[10090]=11,[10151]=12,[10280]=13}
local t=t[n]
if t then
local t=a[t]
for n,t in ipairs(t)do
e._AddUniqueVolunteerStaff(t)
end
end
end
...
function e.ForceStartBuildPlatform(e,t)
...
function e.OpenDeployMission(t)
for t,e in ipairs(t)do
TppMotherBaseManagement.SetSequentialMissionIdLimit{deployMissionId=e}
end
end
e.RewardLangIdTable={Combat={"reward_105","reward_106"},BaseDev={"reward_100","reward_101"},Spy={"reward_102"},Medical={"reward_103"},Security={"reward_108"},Hospital={"reward_104"}
}
...
function e.IsCleardRetakeThePlatform()
return TppStory.IsMissionCleard(10115)
end
function e.IsFailedRetakeThePlatform()
...
function e.CanConstructFirstFob()
...
function e.IsConstructedFirstFob()
...
function e.IsReleaseFunctionBattle()
if gvars.str_storySequence>=TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON then
return true
else
return false
...
function e.IsReleaseFunctionNuclearDevelop()
...
t=e.SectionFuncOpenCondition[a]
[o]
end
if(t==true)then
...
function e.IsBuiltAnimalPlatform()
local e=gvars.trm_animalRecoverHistorySize
...
function e.SetActiveTerminalMenu(t)
if not Tpp.IsTypeTable(t)then
return
end
