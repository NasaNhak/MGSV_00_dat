...
e.MissionCollectionMissionTaskTable={
[10020]={30},
[10033]={17},
[10036]={17,18},
[10043]={"first"},
...
function e.SetUpConnectLandingZoneTable(e)
...
local n=e.GetGimmickID(a,n,t)
if not n then
return
end
e.BreakConnectedGimmick(n)
e.CheckBrokenAndBreakConnectedGimmick(n)
e.HideAsset(n)
e.ShowAnnounceLog(n)
e.UnlockLandingZone(n)
local t=false
if(i==o)then
t=true
end
e.PowerCut(n,true,t)
e.SetHeroicAndOrgPoint(n,i)
end
...
function e.UnlockLandingZone(e)
