...
local t=((5*24)*60)*60
e.MOVET_TO_POSITION_RESULT={
[o"success"]="success",[o"failure"]="failure",[o"timeout"]="timeout"}
e.messageExecTable={
}
function e.Messages()
return Tpp.StrCode32Table{Player={
{msg="DemoSkipped",func=e.OnDemoSkipAndBlockLoadEnd,option={isExecDemoPlaying=true,isExecMissionClear=true,isExecGameOver=true}
},
{msg="DemoSkipStart",func=e.EnableWaitBlockLoadOnDemoSkip,option={isExecDemoPlaying=true,isExecMissionClear=true,isExecGameOver=true}
},
{msg="FinishInterpCameraToDemo",func=e.OnEndGameCameraInterp,option={isExecMissionClear=true,isExecGameOver=true}
},
...
{msg="PlayInit",func=e._OnDemoInit,option={isExecMissionClear=true,isExecDemoPlaying=true,isExecGameOver=true}
},
{msg="Play",func=e._OnDemoPlay,option={isExecMissionClear=true,isExecDemoPlaying=true,isExecGameOver=true}
},
{msg="Finish",func=e._OnDemoEnd,option={isExecMissionClear=true,isExecDemoPlaying=true,isExecGameOver=true}
},
{msg="Interrupt",func=e._OnDemoInterrupt,option={isExecMissionClear=true,isExecDemoPlaying=true}
},
{msg="Skip",func=e._OnDemoSkip,option={isExecMissionClear=true,isExecDemoPlaying=true}
},
{msg="Disable",func=e._OnDemoDisable},
...
{msg="DemoPauseSkip",func=e.FadeOutOnSkip,option={isExecMissionClear=true,isExecDemoPlaying=true,isExecGameOver=true}
}
},Timer={
...
function e.PlayGetIntelDemo(l,d,i,n,t)
local o=n or{
}o.isSnakeOnly=false
local n,a
if t then
n,a="p31_010026","p31_010026_001"else
n,a="p31_010025","p31_010025_001"
end
local t="_getInteldemo"local r="_getInteldemo02"e.AddDemo(t,n)
e.AddDemo(r,a)
...
function e.CheckEventDemoDoor(r,n,e)
...
mvars.demo_playRequestInfo={missionBlock={
},demoBlock={
}
}
...
function e.OnMessage(i,r,o,a,t,l,n)
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,i,r,o,a,t,l,n)
end
function e.FadeOutOnSkip()
TppUI.FadeOut(TppUI.FADE_SPEED.FADE_MOMENT)
end
function e.OnDemoPlay(a,t)
...
if(n=="p31_080110_000_final")then
if GkEventTimerManager.IsTimerActive"p31_080110_000_showLocationTelop"
then
...
function e.DoOnEndMessage(n,r,o,t,a)
if(not r)then
local e=true
if t and(not a)then
e=false
...
local e={missionStateCheck=false,gameCameraInterpedToDemo=i,demoBlockLoaded=r,playerModelReloaded=o,playerActionAllowed=a,playerMoveToPosition=n,waitTextureLoadOnDemoPlay=t}
return e
end
function e.DeletePlayRequestInfo(e,n)
if n and n.useDemoBlock then
...
function e.CanStartPlay(o,t)
local a=true
for n,r in pairs(t)do
if r==false then
local e=e.PLAY_REQUEST_START_CHECK_FUNC[n](o)
if e then
t[n]=true
else
a=false
...
function e.CanFinishPlay(o,t)
local n=true
for a,r in pairs(t)do
if r==false then
local e=e.FINISH_WAIT_CHECK_FUNC[a](o)
if e then
t[a]=true
else
n=false
...
function e._OnDemoInit(n)
local n=mvars.dem_invScdDemolist[n]
if n then
e._DoMessage(n,"onInit")
end
end
function e._OnDemoPlay(a)
local n=mvars.dem_invScdDemolist[a]
if n then
e.DisableGameStatusOnPlayStart()
e.OnDemoPlay(n,a)
e._DoMessage(n,"onStart")
end
end
function e._OnDemoEnd(n)
local n=mvars.dem_invScdDemolist[n]
if n then
e.OnDemoEnd(n)
...
function e._OnDemoInterrupt(n)
local n=mvars.dem_invScdDemolist[n]
if n then
e.OnDemoInterrupt(n)
e._DoMessage(n,"onInterrupt")
end
end
function e._OnDemoSkip(a)
local n=mvars.dem_invScdDemolist[a]
if n then
e.OnDemoSkip(n,a)
e._DoMessage(n,"onSkip")
end
end
function e._OnDemoDisable(n)
local n=mvars.dem_invScdDemolist[n]
if n then
e.OnDemoDisable(n)
e._DoMessage(n,"onDisable")
mvars.dem_playedList[n]=nil
end
end
function e._DoMessage(n,a)
if((mvars.dem_demoFuncs==nil or mvars.dem_demoFuncs[n]==nil)or mvars.dem_demoFuncs[n]
[a]==nil)then
return
end
mvars.dem_demoFuncs[n]
[a]()
end
...
if e.IsPlayedMBEventDemo"EntrustDdog"
then
return false
end
...
if e.IsPlayedMBEventDemo"DdogComeToGet"
then
return false
end
...
if e.IsPlayedMBEventDemo"AttackedFromOtherPlayer_KnowWhereFrom"or e.IsPlayedMBEventDemo"AttackedFromOtherPlayer_UnknowWhereFrom"
then
return false
end
...
if e.IsPlayedMBEventDemo"MoraleOfMBIsLow"
then
return false
end
...
if e.IsPlayedMBEventDemo"OcelotIsPupilOfSnake"
then
return false
end
...
if e.IsPlayedMBEventDemo"HappyBirthDay"
then
return false
end
...
if e.IsPlayedMBEventDemo"QuietOnHeliInRain"
then
return false
else
local n=TppStory.GetCurrentStorySequence()>=TppDefine.STORY_SEQUENCE.CLEARD_OKB_ZERO
...
if e.IsPlayedMBEventDemo"QuietHasFriendshipWithChild"
then
return false
else
...
if e.IsPlayedMBEventDemo"QuietWishGoMission"
then
return false
end
...
if e.IsPlayedMBEventDemo"SnakeHasBadSmell_WithoutQuiet"
then
return false
end
...
if e.IsPlayedMBEventDemo"SnakeHasBadSmell_000"
then
return false
end
...
if e.IsPlayedMBEventDemo"EliLookSnake"
then
return false
end
return false
end,LiquidAndChildSoldier=function()
if e.IsPlayedMBEventDemo"LiquidAndChildSoldier"
then
return false
end
...
if e.IsPlayedMBEventDemo"InterrogateQuiet"
then
return false
else
...
if e.IsPlayedMBEventDemo"DecisionHuey"
then
return false
end
if TppStory.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.DECISION_HUEY)and TppRadio.IsPlayed"f2000_rtrg8410"
then
return true
else
return false
...
e.ClearPlayedMBEventDemoFlag"HappyBirthDay"
end
else
...
function e.IsBattleHangerDemo(e)
...
e.EnableGameStatus(n,a.exceptGameStatus)
end
