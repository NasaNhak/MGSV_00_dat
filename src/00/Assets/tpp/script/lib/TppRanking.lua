...
local n={
[30010]=true,[30020]=true,[30050]=true}
...
{msg="CBoxSlideEnd",func=e.OnCBoxSlideEnd}
},GameObject={
...
return{
{name="rnk_isUpdated",arraySize=TppDefine.RANKING_MAX,type=TppScriptVars.TYPE_BOOL,value=false,save=true,sync=false,wait=false,category=TppScriptVars.CATEGORY_MISSION}
}
end
return e
