...
local n
for e,s in ipairs(e.missionPackList)do
if s==i then
n=e
break
end
...
function e.AddLocationCommonScriptPack(i)
...
local n=TppDefine.MISSION_ENUM[tostring(i)]
if n then
e.AddMissionPack"/Assets/tpp/pack/mission2/common/online_challenge.fpk"
end
end
...
e.AddMissionPack"/Assets/tpp/pack/fova/mecha/all/mfv_scol_c11.fpk"e.AddMissionPack"/Assets/tpp/pack/fova/mecha/all/mfv_scol_c07.fpk"
end
end
function e.AddFOBLayoutPack(n)
local s,i=e.GetMissionTypeAndMissionName(n)
if n==50050 then
end
...
local i=true
if n==10010 and e.IsMissionPackLabel"afterMissionClearMovie"
then
i=false
end
if i then
...
function e.GetLocationNameFormMissionCode(s)
local e
for n,i in pairs(TppDefine.LOCATION_HAVE_MISSION_LIST)do
