...
function this.MissionPrepare()
	...
	if TppPackList.IsMissionPackLabel("default") then
		...
		local maxReceiverBlockSize	= 272 * 1024	
		local maxSightBlockSize		= 105 * 1024	--> Update 1.0.14
		local platform = Fox.GetPlatformName()
		if not ( ( platform == "Xbox360" ) or ( platform == "PS3" ) ) then
			maxReceiverBlockSize	= 330 * 1024	--> Update 1.0.14
			maxSightBlockSize		= 106 * 1024	--> Update 1.0.14
		end
		TppEquip.CreateEquipPreviewSystem{
			...
			maxSightBlockSize		= maxSightBlockSize,	--> Update 1.0.14
...
local SelectCameraParameter = {
	...
	[ Fox.StrCode32( "MissionPrep_FocusTarget_Weapon" ) ]
		= { "WeaponPosition", 1.5, rotX = -10, rotY = 170, interpTime = 0.3,},

	[ Fox.StrCode32( "MissionPrep_FocusTarget_PrimaryWeapon" ) ]
		= { "PlayerPosition", 3.0, rotX = 5, rotY = 230, interpTime = 0.4 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_PrimaryWeapon_HIP" ) ]
		= { "PlayerPosition", 2.5, rotX = 5, rotY = 220, interpTime = 0.4 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_PrimaryWeapon_BACK" ) ]
		= { "PlayerPosition_Up", 3.0, rotX = 5, rotY = 320, interpTime = 0.4 },




	[ Fox.StrCode32( "MissionPrep_FocusTarget_SecondaryWeapon" ) ]
		= { "PlayerPosition", 3.0 , rotX = -5, rotY = 160, interpTime = 0.3 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_SecondaryWeapon_WEAPON" ) ]
		= { "PlayerPosition", 2.0 , rotX = -5, rotY = 150, interpTime = 0.3 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_SecondaryWeapon_ARM" ) ]
		= { "PlayerPosition_Up", 2.0 , rotX = -5, rotY = 230, interpTime = 0.3 },




	[ Fox.StrCode32( "MissionPrep_FocusTarget_SupportWeapon" ) ]
		= { "PlayerPosition_Up", 1.8 , rotX = -5, rotY = 170, interpTime = 0.3 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_Item" ) ]
		= { "PlayerPosition_Up", 3.3 , rotX = -5, rotY = 170, interpTime = 0.3 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_Suit" ) ]
		= { "PlayerPosition_Up", 3.3, rotX = -5, rotY = 170, interpTime = 0.3 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_HeadOption" ) ]
	...
	[ Fox.StrCode32( "MissionPrep_FocusTarget_BuddyQuietEquip" ) ]
		= { "BuddyQuietPosition_Up", 3.2, rotX = -5, rotY = 270, interpTime = 0.4 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_BuddyDog" ) ]
		= { "BuddyDogPosition", 3.8, rotX = -5, rotY = 182, interpTime = 0.3 },


	[ Fox.StrCode32( "MissionPrep_FocusTarget_BuddyHorse" ) ]
		= { "BuddyHorsePosition_2", 5.3, rotX = -5, rotY = 180, interpTime = 0.3 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_BuddyWalker" ) ]
		= { "BuddyPosition", 4.0, rotX = -5, rotY = 170, interpTime = 0.3 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_BuddyBattleGear" ) ]
		= { "BuddyPosition", 5.8, rotX = -5, rotY = 170, interpTime = 0.3 },



	[ Fox.StrCode32( "MissionPrep_FocusTarget_Vehicle" ) ]
		= { "VehicleCameraPosition", 9.0, rotX = 24, rotY = 65, interpTime = 0.6 },

	[ Fox.StrCode32( "MissionPrep_FocusTarget_None" ) ]
		= { "StageCenter", 3.5, rotX = -5, rotY = 170, interpTime = 0.3 },

	[ Fox.StrCode32( "Customize_Target_Weapon" ) ]
	...
	[ Fox.StrCode32( "Customize_Weapon_AssaultRifle" ) ]
		= { "CustomizeWeaponPosition", 1.5, rotX = 0, rotY = 180, interpTime = 0.3 },
	[ Fox.StrCode32( "Customize_Weapon_ShotGun" ) ]
		= { "CustomizeWeaponPosition", 1.5, rotX = 0, rotY = 180, interpTime = 0.3 },
	[ Fox.StrCode32( "Customize_Weapon_GrenadeLauncher" ) ]
		= { "CustomizeWeaponPosition", 1.5, rotX = 0, rotY = 180, interpTime = 0.3 },
	[ Fox.StrCode32( "Customize_Weapon_SniperRifle" ) ]
		= { "CustomizeWeaponPosition", 1.7, rotX = 0, rotY = 180, interpTime = 0.3 },
	[ Fox.StrCode32( "Customize_Weapon_MachineGun" ) ]
		= { "CustomizeWeaponPosition", 1.7, rotX = 0, rotY = 180, interpTime = 0.3 },
	...
	[ Fox.StrCode32( "Customize_Target_Horse_Body" ) ]
		= { "CustomizeBuddyPosition_HorsePos", 4.5, rotX = -5, rotY = 170, interpTime = 0.3 },
	[ Fox.StrCode32( "Customize_Target_Horse_Head" ) ]
		= { "CustomizeBuddyPosition_HorsePos", 4.5, rotX = -5, rotY = 170, interpTime = 0.3 },
	...
	[ Fox.StrCode32( "Customize_Target_Heli_OpFlare" ) ]
		= { "CustomizeHelicopterCameraPosition", 16 , rotX = -5, rotY = 170, interpTime = 0.3 },
	[ Fox.StrCode32( "Customize_Target_Heli_OpArmor" ) ]
		= { "CustomizeHelicopterCameraPosition", 16 , rotX = -5, rotY = 170, interpTime = 0.3 },
	[ Fox.StrCode32( "Customize_Target_Heli_Color" ) ]
		= { "CustomizeHelicopterCameraPosition", 16 , rotX = -5, rotY = 170, interpTime = 0.3 },




	[ Fox.StrCode32( "Customize_Target_Helicopter" ) ]
		= { "CustomizeHelicopterCameraPosition", 16 , rotX = -5, rotY = 170, interpTime = 0.3 },


	[ Fox.StrCode32( "Customize_Target_Vehicle" ) ]
...
function this.UpdateCameraParameter( focusTarget, immediately )
	...
	if focusTarget == Fox.StrCode32( "Customize_Target_Buddy" )
	or focusTarget == Fox.StrCode32( "MissionPrep_FocusTarget_BuddyQuiet" )
	or focusTarget == Fox.StrCode32( "MissionPrep_FocusTarget_BuddyQuietEquip" )
	or focusTarget == Fox.StrCode32( "MissionPrep_FocusTarget_BuddyDog" )
	or focusTarget == Fox.StrCode32( "MissionPrep_FocusTarget_BuddyHorse" )
	or focusTarget == Fox.StrCode32( "MissionPrep_FocusTarget_BuddyWalker" )
	or focusTarget == Fox.StrCode32( "MissionPrep_FocusTarget_BuddyBattleGear" )  then
		ignoreCollision = GameObject.CreateGameObjectId( "TppWalkerGear2", 0 )
	elseif focusTarget == Fox.StrCode32( "Customize_Target_Vehicle" )
	or focusTarget == Fox.StrCode32( "MissionPrep_FocusTarget_Vehicle" ) then
...
sequences.Seq_Game_WeaponCustomize = {
	...
	OnEnter = function( self )
		...
		if mvars.startCustomizeTarget == Fox.StrCode32( "Customize_Target_Weapon" ) then
		...
		elseif mvars.startCustomizeTarget == Fox.StrCode32( "Customize_Target_Helicopter" )
		or mvars.startCustomizeTarget == Fox.StrCode32( "Customize_Target_Vehicle" ) then
